...
KR_SECTOR_TOP = {
    ...
    '금융·은행':  [('105560','KB금융'),('055550','신한지주'),('086790','하나금융지주'),
                  ...
                  ('060000','메리츠금융지주'),('000810','삼성화재'),('005830','DB손해보험'),('001450','현대해상')],
    ...
    '방산·우주':  [('012450','한화에어로스페이스'),('047810','한국항공우주'),('000880','한화'),
                  ...
                  ('009540','HD한국조선해양'),('010140','삼성중공업'),('064350','현대로템'),('015210','대우건설')],
    ...
    '통신':      [('017670','SK텔레콤'),('030200','KT'),('032640','LG유플러스'),
                  ...
                  ('293490','카카오게임즈'),('112040','위메이드'),('263750','펄어비스'),('036490','SK브로드밴드')],
